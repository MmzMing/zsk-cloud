...
INSERT INTO zsk_system.sys_menu (id, menu_name, parent_id, order_num, path, component, query, is_frame, is_cache, menu_type, visible, status, perms, icon, deleted, create_name, create_time, update_name, update_time, remark) VALUES (2301, '视频列表', 2004, 2, '/admin/video/list', 'video/list', '', 1, 0, 'C', 0, 0, 'video:list:view', 'folder-open', 0, 'admin', '2026-04-20 15:17:27', '771220492@qq.com', '2026-04-26 18:28:45', null);
INSERT INTO zsk_system.sys_menu (id, menu_name, parent_id, order_num, path, component, query, is_frame, is_cache, menu_type, visible, status, perms, icon, deleted, create_name, create_time, update_name, update_time, remark) VALUES (2302, '编辑创建', 2004, 1, '/admin/video/upload', 'video/upload', '', 1, 0, 'C', 0, 0, 'video:upload:view', 'upload', 0, 'admin', '2026-04-20 15:17:27', '771220492@qq.com', '2026-04-26 18:28:54', null);
...
INSERT INTO zsk_system.sys_menu (id, menu_name, parent_id, order_num, path, component, query, is_frame, is_cache, menu_type, visible, status, perms, icon, deleted, create_name, create_time, update_name, update_time, remark) VALUES (2404, '文档审核', 2005, 3, '/admin/document/audit', 'document/audit', '', 1, 0, 'C', 0, 0, 'document:audit:view', 'check-circle', 0, 'admin', '2026-04-20 15:17:27', '771220492@qq.com', '2026-04-26 18:28:25', null);
